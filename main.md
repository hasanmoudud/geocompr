...
The version of the book you are reading now was built on 2018-06-19 and was built on [Travis](https://travis-ci.org/Robinlovelace/geocompr).
...
On the other hand compiled languages such as C++ and Java tend to run faster.
...
Table: (\#tab:revdep)The top 5 most downloaded packages that depend on sf, in terms of average number of downloads per day over the previous month. As of 2018-06-14 there are 80 packages which import sf.
